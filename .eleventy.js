...
module.exports = function (eleventyConfig) {
  // adds the navigation plugin for easy nav
  ...
  // allows the {% image %} shortCode to be used for optimized images (in webp if possible)
  ...
  return {
    ...
    // allows .html files to contain nunjucks template language
